 local r0_4 = loadstring(game:HttpGet("https://raw.githubusercontent.com/TimShadow1/dollarhub/refs/heads/main/orionlib.lua"))()
      ...
      r0_4:MakeNotification({
        Name = "$ Hub",
        Content = "This script ha loaded.feito pela lenda star",
      ...
      r5_4:AddLabel("valeu por ta usando o script")
      r5_4:AddButton({
      ...
      r4_4:MakeTab({
        ...
        Name = "ï¿½Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾Ð»Ð½Ð¾ÑÑ‚ÑŒÑŽ Ñ…Ð°Ð±? \nClose the hub completely?",
        Callback = function()
          -- line: [0, 0] id: 292
          r0_4:Destroy()
        end,
      ...
      r7_4:AddButton({
        Name = "FE Invisible - ÑÑ‚Ð°Ñ‚ÑŒ Ð½ÐµÐ²Ð¸Ð´Ð¸Ð¼Ñ‹Ð¼",
        Callback = function()
          -- line: [0, 0] id: 729
      ...
      r7_4:AddButton({
        Name = "Anna Bypasser (Change the language to ÐšÐ°Ð·Ð°Ðº Ð¢Ð¸Ð»Ð¸)",
        Callback = function()
          -- line: [0, 0] id: 612
      ...
      r58_4:AddLabel("ï¿½ ÑÐ¾Ð»Ð°Ñ€Ð¸ÑÐµ Ð½Ðµ ÑŽÐ·Ð°Ð¹Ñ‚Ðµ Kill All Ð¸Ð½Ð°Ñ‡Ðµ Ð²Ð°Ñ Ð·Ð°Ð±Ð°Ð½ÑÑ‚")
      ...
      r70_4:AddLabel("ï¿½ÑÐ»Ð¸ Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ Ð²Ð²ÐµÑÑ‚Ð¸ ÐºÐ»ÑŽÑ‡ Ð² Alter Hub Ð²Ð¾Ñ‚ Ð¾Ð½: 25ms")
      ...
      r70_4:AddLabel("ï¿½Ð¾Ð³Ð´Ð° Ð·Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚ÑÑ ÑÐºÑ€Ð¸Ð¿Ñ‚ Nuke Hub Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ghost GUI")
      ...
      r73_4:AddLabel("ï¿½ÑÐ»Ð¸ Ð² NS Hub Ð¿Ð¾Ð¿Ñ€Ð¾ÑÐ¸Ñ‚ ÐºÐ»ÑŽÑ‡ Ð²Ð¾Ñ‚ Ð¾Ð½: 25ms")
      ...
      r75_4:AddLabel("ï¿½ÑÐ»Ð¸ Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ Ð²Ð²ÐµÑÑ‚Ð¸ ÐºÐ»ÑŽÑ‡ Ð² Alter Hub Ð²Ð¾Ñ‚ Ð¾Ð½: 25ms")
      ...
      r114_4:AddButton({
        Name = "No Fall Damage - ÐÐµ Ð¿Ð¾Ð»ÑƒÑ‡Ð°Ñ‚ÑŒ ÑƒÑ€Ð¾Ð½ Ð¾Ñ‚ Ð¿Ð°Ð´ÐµÐ½Ð¸Ñ",
        Callback = function()
          -- line: [0, 0] id: 531
      ...
      r140_4:AddLabel("ï¿½ÑÐ»Ð¸ Ð² NS Hub Ð¿Ð¾Ð¿Ñ€Ð¾ÑÐ¸Ñ‚ ÐºÐ»ÑŽÑ‡ Ð²Ð¾Ñ‚ Ð¾Ð½: 25ms")
      ...
      r163_4:AddLabel("ï¿½ÑÐ»Ð¸ ÑÐºÑ€Ð¸Ð¿Ñ‚ Ð½Ðµ Ð¿Ñ€Ð¾Ð³Ñ€ÑƒÐ¶Ð°ÐµÑ‚ÑÑ Ð·Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚Ðµ ÐµÐ³Ð¾ ÐµÑ‰Ðµ Ñ€Ð°Ð·")
      r163_4:AddLabel("ï¿½ ÐµÑÐ»Ð¸ Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ ÐºÐ»ÑŽÑ‡ Ð²Ð¾Ñ‚ Ð¾Ð½: 25ms")
      ...
      r166_4:AddLabel("ï¿½Ð¾Ð¶ÐµÑ‚ Ð´Ð¾Ð»Ð³Ð¾ Ð·Ð°Ð³Ñ€ÑƒÐ¶Ð°Ñ‚ÑŒÑÑ. ÐšÐ»ÑŽÑ‡: usernaxo")
